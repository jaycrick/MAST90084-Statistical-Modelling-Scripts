...
Usually we don't extract the random effects estimates directly (since there is only a posterior distribution), but we can extract the conditional modes using the generic method `ranef()`:
